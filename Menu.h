...
struct Menu
{
    ...
    static void showUsage()
    {
        ...
        std::cout << "\n\n    Place  (Place <Robot> <X,Y> <North, South, West, East>) e.g. Place "
                     "R2D2 1,1 North";
        std::cout << "\n\n    Move   (Move <Robot> <number of units> or Move All, which moves all "
                     "the robots)";
        std::cout << "\n    Rotate (Rotate <Robot/All> <left/right> or Left/Right <Robot/All>; all "
                     "robots will rotate if none is specified)";
        std::cout << "\n    Remove (Remove <Robot/All>; all robots will be removed if none is "
                     "specified )";
